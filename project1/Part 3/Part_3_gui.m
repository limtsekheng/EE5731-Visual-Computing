function varargout = Part_3_gui(varargin)
% PART_3_GUI MATLAB code for Part_3_gui.fig
%      PART_3_GUI, by itself, creates a new PART_3_GUI or raises the existing
%      singleton*.
%
%      H = PART_3_GUI returns the handle to a new PART_3_GUI or the handle to
%      the existing singleton*.
%
%      PART_3_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PART_3_GUI.M with the given input arguments.
%
%      PART_3_GUI('Property','Value',...) creates a new PART_3_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Part_3_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Part_3_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Part_3_gui
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Part_3_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @Part_3_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Part_3_gui is made visible.
function Part_3_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = Part_3_gui_OutputFcn(hObject, eventdata, handles)
